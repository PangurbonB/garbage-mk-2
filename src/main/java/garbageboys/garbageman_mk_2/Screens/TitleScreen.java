...
public class TitleScreen implements Screen {
	...
	public void loadAssets() {
		...
		temp_text_object = text.openText("GARBAGEMAN: One man's trash is another's food.", .5f, .35f, .75f, 86, 650);
		text_list.add(temp_text_object);
		temp_text_object = text.openText("PLAY", 1.25f, .45f, .53f, 100, 200);
		text_list.add(temp_text_object);
